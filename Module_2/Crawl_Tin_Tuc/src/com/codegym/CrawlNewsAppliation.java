...
public class CrawlNewsAppliation {
    ...
    private void display(LinkedList<String> list) {
        String targetPath = "/root/Documents/Codegym_Projects/Module_2/Crawl_Tin_Tuc/src/com/codegym/News.txt";
        PrintWriter out = null;
        try {
            try {
