...
public class Logger {
    ...
    @AfterThrowing(pointcut = "execution(public * com.codegym.controller.ShoppingCartController.*(..))", throwing = "ex")
    ...
    @After("execution(public * com.codegym.controller.ShoppingCartController.borrowBook(..))")
    ...
    @After("execution(public * com.codegym.controller.ShoppingCartController.returnBook(..))")
